...
DATA(insert OID = 150 ( bson		   PGNSP PGUID -1 f b U f t \054 0 0 151 bson_in bson_out bson_recv bson_send - - - i x f 0 -1 0 0 _null_ _null_ _null_ ));
#define BSONOID 150
DATA(insert OID = 151 ( _bson	   PGNSP PGUID -1 f b A f t \054 0 150 0 array_in array_out array_recv array_send - - array_typanalyze i x f 0 -1 0 0 _null_ _null_ _null_ ));
