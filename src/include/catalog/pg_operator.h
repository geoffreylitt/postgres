...
DATA(insert OID = 3968 (  "->"	   PGNSP PGUID b f f 150 25 150 0 0 bson_object_field - - ));
DESCR("get bson object field");
DATA(insert OID = 3969 (  "->>"    PGNSP PGUID b f f 150 25 25 0 0 bson_object_field_text - - ));
DESCR("get bson object field as text");
DATA(insert OID = 3970 (  "->"	   PGNSP PGUID b f f 150 23 150 0 0 bson_array_element - - ));
DESCR("get bson array element");
DATA(insert OID = 3971 (  "->>"    PGNSP PGUID b f f 150 23 25 0 0 bson_array_element_text - - ));
DESCR("get bson array element as text");
DATA(insert OID = 3972 (  "#>"     PGNSP PGUID b f f 150 1009 150 0 0 bson_extract_path_op - - ));
